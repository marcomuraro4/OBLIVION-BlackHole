...
Node Server and bridging were implemented thourgh [osc.js](https://github.com/colinbdclark/osc.js) library by Colin Clark, whereas the OSC Client was created and set up using [osc-js](https://github.com/adzialocha/osc-js) library.
